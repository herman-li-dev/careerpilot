<template>
  <main class="page-shell">
    ...
    <footer class="legal-footer">
      <p>CareerPilot · Evidence-grounded career preparation</p>
      <nav aria-label="Legal information">
        <RouterLink to="/privacy">Privacy Policy</RouterLink>
        <RouterLink to="/terms">Terms of Service</RouterLink>
        <a href="mailto:hermanli.dev@gmail.com">Support</a>
      </nav>
    </footer>
...
.legal-footer { max-width: 1220px; margin: 48px auto 0; padding-top: 24px; border-top: 1px solid #e3e6f0; display: flex; align-items: center; justify-content: space-between; gap: 20px; color: #64708a; font-size: .84rem; }.legal-footer nav { display: flex; flex-wrap: wrap; gap: 18px; }.legal-footer a { color: #4d5bc8; font-weight: 700; }.legal-footer a:hover { text-decoration: underline; }
...
@media (max-width: 760px) { .legal-footer { align-items: flex-start; flex-direction: column; } }
</style>
